...
public interface StaffService {
    ...
    /**
     * 根据用户id和机构id获取用户的医生详细信息
     * @param staffId 用户id
     * @param instId 机构id
     * @return
     */
    @RequestMapping(value = "/api/sys/staff/getSysStaffHospByInstIdAndStaffId", method = RequestMethod.POST, consumes = MediaType.APPLICATION_JSON_VALUE)
    SysStaffHosp getSysStaffHospByinstIdAndStaffId(@RequestParam("staffId") Long staffId, @RequestParam("instId") Long instId);
