...
public interface ModuleService {
     ...
     * @return List<Module>
     */
    @RequestMapping(value = "/api/sys/module/getListByPortal", method = RequestMethod.POST)
    List<Module> getListByPortal(@RequestParam("staffId") Long staffId, @RequestParam("instId") Long instId);
    ...
    List<Long> getIdListByInstId(@RequestParam("instId") Long instId);*/
    
    /**
     * 门户获取所有菜单
     * @return List<Module>
     */
    @RequestMapping(value = "/api/sys/module/getAllListByPortal", method = RequestMethod.POST)
    List<Module> getAllListByPortal();
