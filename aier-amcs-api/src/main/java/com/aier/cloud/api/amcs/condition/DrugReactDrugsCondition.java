 ...
 */
public class DrugReactDrugsCondition extends PageCondition implements Serializable {
	...
	public List<Long> getReactIdList() {
		return reactIdList;
	}

	public void setReactIdList(List<Long> reactIdList) {
		this.reactIdList = reactIdList;
	}
