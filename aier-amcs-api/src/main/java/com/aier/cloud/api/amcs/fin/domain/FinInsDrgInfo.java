 ...
 */
@Data
public class FinInsDrgInfo extends BaseEntity {
	/** analysisId*/
	...
	private String drgConsumables;

	/** 最小值*/
	private java.math.BigDecimal drgConsumablesMin;

	/** 最大值*/
	private java.math.BigDecimal drgConsumablesMax;
