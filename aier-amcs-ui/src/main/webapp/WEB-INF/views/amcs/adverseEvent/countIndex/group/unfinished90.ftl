    ...
    if(!$.isEmptyObject(parentParam)){
	 ...
	 $grid.newGrid("#gridBox",{
	  tools:[
	          ...
	          url:'${base}/ui/amcs/countIndex/unfinished90GroupGrid',
		  	  queryParams: parentParam,
		  	    //{province:'${province!''}',reportDateBegin:'${reportDateBegin!''}',reportDateEnd:'${reportDateEnd!''}',eventDateBegin:'${eventDateBegin!''}',eventDateEnd:'${eventDateEnd!''}'},
	          idField:'id',
	          fitColumns : false,
	          pagination : true,
	          // checkbox: true,
