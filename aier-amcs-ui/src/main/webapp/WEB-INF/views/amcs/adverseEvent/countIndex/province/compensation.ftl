...
requirejs(['pub'],function () {
 ...
 $grid.newGrid("#gridBox",{
  tools:[
          ...
          url:'${base}/ui/amcs/countIndex/compensationProvinceGrid',
	  	  queryParams: {
	  	  	reportDateBegin:'${reportDateBegin!''}',reportDateEnd:'${reportDateEnd!''}',eventDateBegin:'${eventDateBegin!''}',eventDateEnd:'${eventDateEnd!''}'
		  },
          idField:'id',
          fitColumns : false,
          pagination : true,
