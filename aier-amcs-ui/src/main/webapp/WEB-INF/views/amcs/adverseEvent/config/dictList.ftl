...
<head>
	...
	<title>不良事件字典配置 - 爱尔医院</title>
	[#include '/WEB-INF/views/common/include_resources.ftl']
</head>
<body>
<div class="searchHead">
	<form id="sbox" class="soform form-enter">
		<input id="paraType" class="txt  w-100" name="paraType" value="sub_type"  />
		<input class="hidden" id="filter" class="txt" name="filter" value="" type="hidden" />
...
<script id="formTem" type="text/html">
	<form id="infoForm" class="soform form-validate pad-t20 pad-r20 form-enter"
		...
		<div class="row">
			...
			<div class="p3">
				<div class="item-one">
					<label class="lab-item">类型编码</label>
					<input class="txt txt-validate" type="text" name="typeCode" id="typeCode" validType="maxlength[50]" noNull="必填" value=""/>
				</div>
			</div>
[#--			<div class="p3">--]
[#--				<div class="item-one">--]
...
[#--			</div>--]
		...
		<div class="row">
			<div class="p3">
				<div class="item-one">
					<label class="lab-item">下拉框过滤值</label>
					<input class="txt txt-validate" type="text" name="comboboxFilter" id="comboboxFilter" value=""/>
				</div>
			</div>
			<div class="p3">
				<div class="item-one">
					<label class="lab-item">过滤器值</label>
					<input class="txt txt-validate" type="text" name="filter" id="filter"  value=""/>
				</div>
			</div>
			<div class="p3">
				<div class="item-one">
		...
		<div class="row">
			<div class="p3">
				<div class="item-one">
					...
					<input class="txt txt-validate" type="text" name="usingSign" id="usingSign"  value=""/>
				</div>
			</div>
		</div>
[#--		<div class="row">--]
...
<script type="text/javascript">
	requirejs(["pub"], function () {
		...
		$grid.newGrid("#gridBox", {
			...
			columns: [
				[
					...
					{title: "拼音码", field: "firstSpell", hidden: false, width: 150},
					    ...
					    {title: "下拉过滤值", field: "comboboxFilter", hidden: false, width: 160},
					...
					{title: "过滤器值", field: "filter", hidden: false, width: 100},
			...
			onLoadSuccess: function (data) {
				...
				$('.s-op-del').click(function () {
					...
					$ajax.post({
						url: '${base}/ui/amcs/adverse/aeDict/del',
						data: {id:row["id"]},
			...
			url: "${base}/ui/amcs/adverse/aeDict/getList",
		});
		...
		window.submitEditForm = function (opt, $form, data) {
			...
			data.nodeValue=a;
			$ajax.post({
				url: '${base}/ui/amcs/adverse/aeDict/save',
				data: data,
				tip: '你确定提交吗？',
				success: function (rst) {
					$pop.close(formPop);
