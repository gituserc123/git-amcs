  ...
  $grid.newGrid("#gridBox",{
        ...
        onLoadSuccess : function (data) {
          $('.s-op-del').click(function () {
            ...
            $ajax.post('${base}/ui/amcs/adverse/event/config/remove/'+id,null,'确定删除此省区角色吗？').done(function (rst) {
              if (rst) {
        ...
        ,offset : -2
        ,url: '${base}/ui/amcs/adverse/event/config/list'
      });
...
[#--  [@shiro.hasPermission name = "Module:view"]--]
    $('#ul-moduleTree').tree({
        animate : true,
        lines : true,
        url:'${base}/ui/amcs/adverse/event/config/tree',
        flatData: true,
