    ...
    requirejs(['lodash', "easygridEdit", 'pub'], function (_, $e) {
    	...
    	$grid.newGrid("#gridBox",{
	    	...
	    	columns:[[
                ...
                {title:'老年性白内障结算标准(元)',field:'f8',align:'center',width:180, colspan:3},
                {title:'翼状胬肉结算标准(元)',field:'f9',align:'center', width:180,colspan:3},
                {title:'眼底注药结算标准(元)',field:'f10',align:'center', width:180,colspan:3},
                {title:'眼底玻切结算标准(元)',field:'f10',align:'center', width:180,colspan:3}
            ],[
                {field:'',title:'DRG分组',field:'groupName1',width:120},
                {field:'',title:'单眼',field:'singleEye1',width:100},
                {field:'',title:'双眼',field:'coupleEye1',width:100},
                {field:'',title:'DRG分组',field:'groupName2',width:120},
                {field:'',title:'单眼',field:'singleEye2',width:100},
                {field:'',title:'双眼',field:'coupleEye2',width:100},
                {field:'',title:'DRG分组',field:'groupName3',width:120},
                {field:'',title:'单眼',field:'singleEye3',width:100},
                {field:'',title:'双眼',field:'coupleEye3',width:100},
                {field:'',title:'DRG分组',field:'groupName4',width:120},
                {field:'',title:'单眼',field:'singleEye4',width:100},
                {field:'',title:'双眼',field:'coupleEye4',width:100}
            ]],
            ...
            onLoadSuccess:function(data){
      		...
      		url: '${base}/ui/amcs/fin/drg/ma/getDrgAll',
      		offset : -50
  		});
