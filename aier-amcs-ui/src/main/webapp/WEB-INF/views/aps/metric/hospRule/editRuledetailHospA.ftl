...
//         				$ajax.postJson('${base}/ui/amcs/aps/ruleDetail/refreshGroupRule?id='+id,{},"缺失配置的项目将刷新进当前规则，确定吗?").done(function(rst){
                      ...
                      var popId = $pop.popTemForm({
						...
						beforeSubmit : function (opt,$form, data) {
		                    ...
		                    $.each(chkRows,function(i,v){
		                    	if(data.ruleItemType == v.ruleItemType || data.ruleItemType==''){
            ...
            showFooter : true,
            columns:[[
            	{title:'selected',field:'selected',checkbox:true,},
                ...
                {title:'医院计分项目编码',field:'itemCode',width:'130px',hidden:false,editor:{type:'readonly'}},
                {title:'医院计分项目名称',field:'itemName',align:'left',width:'130px',editor:{type:'readonly'}},
