    ...
    require(["easygridEdit","pub"],function($e) {
        ...
        $grid.newGrid("#gridBox",{
            ...
            columns:[[
                ...
                {title:'状态',field:'usingSignDesc',width:'80px',hidden:false,editor:{
                        type: 'combobox', options: {
                            ...
                            panelHeight:"auto",
                            panelMaxHeight:200,
                            data : [{valueCode:'1', valueDesc: "启用"},{valueCode:'0', valueDesc: "停用"},],
                            required: true,
							 missingMessage:'请选择',
                            onSelect : function (record){
                                var newData = {
                                    usingSign : record.valueCode
                                };
                ...
                {title:'套餐ID',field:'itemCode',width:'160px',hidden:false,editor:{type:'readonly'}},
                {title:'套餐名称',field:'itemName',align:'left',width:'300px',editor:{type:'readonly'}},
                ...
                {title:'usingSign',field:'usingSign',hidden:true,width:0,editor:{type:'readonly'}},
