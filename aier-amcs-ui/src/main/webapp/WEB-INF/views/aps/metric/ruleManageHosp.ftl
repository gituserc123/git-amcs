...
requirejs(['easygridEdit','pub'],function () {
	...
	$grid.newGrid("#gridBoxRule",{
        tools:[
          [
            {iconCls:'plus_sign',text:'新增规则',url:'${base}/ui/amcs/aps/hospRule/page/addRuleHosp?metricId=${id}&hospId=${hospId}',popHeight:300,popWidth:900,title:'新增规则'},
           /*  
          ...
          columns:[[
			...
			//{title: "生效时间", field: "ruleBeginDate", hidden: false, width: 100},
          ...
          onLoadSuccess : function (data) {
          	$('.s-op-edit').click(function(){
                ...
                $pop.iframePop({
                  title : '编辑规则',
                  content : '${base}/ui/amcs/aps/hospRule/page/editRuleHosp?id='+id+'&hospId=${hospId}', 
                  area : ['900px','300px']
                },'#gridBoxRule');
              });
             ...
             $('.s-setting').click(function(){
              ...
              $pop.iframePop({
                title : '规则明细维护',
                content : '${base}/ui/amcs/aps/hospRule/page/editRuleDetailHosp?ruleId='+id+'&hospId=${hospId}',
                area : ['98%','98%']
              },'#gridBoxRule');
             });
          ...
          url:'${base}/ui/amcs/aps/metric/getRuleVersion?metricId='+'${id}&hospId='+'${hospId}',
          // height: 'auto',
          offset :-52
      });
	...
	$grid.newGrid("#gridBoxDetail",{
        tools:[
          ...
          url:'${base}/ui/amcs/aps/metric/getList?hospId=${hospId}' ,
          // height: 'auto',
          offset :-52
      });
