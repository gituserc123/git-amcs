		...
		<div class="row">
			...
			<div class="p6">
				<div class="item-one">
			        ...
			        [@ui_select uiShowDefault=false class="drop easyui-combobox" value="0" id="usingSign" name="usingSign" style="width:100%;" tag="@amcs@com.aier.cloud.api.amcs.enums.UsingSignEnum" filterkey="firstSpell" dataOptions="limitToList:true,reversed:true,panelHeight:'auto',panelMaxHeight:200"/]
				</div>
			</div>
			-->
		</div>
