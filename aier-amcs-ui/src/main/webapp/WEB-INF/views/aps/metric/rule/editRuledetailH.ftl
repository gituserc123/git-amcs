    ...
    require(["easygridEdit","pub"],function($e) {
        ...
        $grid.newGrid("#gridBox",{
            ...
            columns:[[
                ...
                {title:'病种分类',field:'itemName',align:'left',width:'181px',editor:{type:'combogrid',options : {
            				pagination : false,
                            clearIcon: true,
                            ...
                            idField:'valueDesc',
                            textField:'valueDesc',
                            url:'${base}/ui/amcs/aps/metric/autoComplete/queryDiseases',
                            required: true,
                            ...
                            columns:[[
                                ...
                                {field: 'valueDesc', title: '病种分类', width:'140px'},
                            ]],
