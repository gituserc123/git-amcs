    ...
    require(["easygridEdit","pub"],function($e) {
        ...
        $grid.newGrid("#gridBox",{
            ...
            columns:[[
                ...
                {title:'视光单据编码',field:'itemCode',width:'80',editor:{type:'readonly'}},
                {title:'视光单据类型',field:'itemName',align:'left',width:'181px',editor:{type:'combogrid',options : {
            				pagination : false,
                            clearIcon: true,
                            ...
                            idField:'valueDesc',
                            textField:'valueDesc',
                            url:'${base}/ui/amcs/aps/metric/autoComplete/queryAvis',
                            required: true,
                            ...
                            columns:[[
                                ...
                                {field: 'valueDesc', title: '视光单据类型', width:'140px'},
                            ]],
