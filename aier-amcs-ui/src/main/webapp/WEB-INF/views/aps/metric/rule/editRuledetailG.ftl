    ...
    require(["easygridEdit","pub"],function($e) {
        ...
        $grid.newGrid("#gridBox",{
            ...
            columns:[[
                ...
                {title:'视光处方编码',field:'itemCode',width:'80',editor:{type:'readonly'}},
                {title:'视光处方类型',field:'itemName',align:'left',width:'181px',editor:{type:'combogrid',options : {
            				pagination : false,
                            clearIcon: true,
                            ...
                            idField:'valueDesc',
                            textField:'valueDesc',
                            url:'${base}/ui/amcs/aps/metric/autoComplete/queryAvisG',
                            required: true,
                            ...
                            columns:[[
                                {field: 'valueCode', title: '编码', width:'40px'},
                                {field: 'valueDesc', title: '视光处方类型', width:'140px'},
                            ]],
                            filter: function(q, row){
                                return row['valueDesc']&&row['valueDesc'].toLowerCase().indexOf(q.toLowerCase()) >-1;
                            },
                            onSelect: function(index, r){
                                var newData = {
                                    itemId : r.id,
                                    itemCode : r.valueCode,
                                    itemName : r.valueDesc,
                                    ruleId : '${entity.id}',
                                };
