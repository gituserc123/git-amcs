    ...
    require(["easygridEdit","pub"],function($e) {
        ...
        $grid.newGrid("#gridBox",{
            ...
            columns:[[
                ...
                {title:'麻醉方式编码',field:'itemCode',width:'80',editor:{type:'readonly'}},
                {title:'麻醉方式名称',field:'itemName',align:'left',width:'181px',editor:{type:'combogrid',options : {
            				pagination : false,
                            clearIcon: true,
                            ...
                            idField:'valueDesc',
                            textField:'valueDesc',
                            url:'${base}/ui/amcs/aps/metric/autoComplete/queryMazui',
                            required: true,
                            ...
                            columns:[[
                                ...
                                {field: 'valueDesc', title: '麻醉方式', width:'140px'},
                            ]],
