        ...
        $grid.newGrid("#gridBox",{
            ...
            columns:[[
                {title:'操作',field:'op',width:'100px',formatter:function (value,row,index) {
                    return '&nbsp;&nbsp;&nbsp;&nbsp;<span class="icon icon-file_text_alt s-setting blue hand" title="编辑区间" rel="'+row.id+'"></span>';
                    }},
                {title:'标签编码',field:'itemCode',width:'80',editor:{type:'readonly'}},
                {title:'标签名称',field:'itemName',align:'left',width:'181px',editor:{type:'readonly'}},
