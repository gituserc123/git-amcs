...
<script type="text/javascript">
    ...
    require(["easygridEdit","pub"],function($e) {
        ...
        $grid.newGrid("#gridBox",{
            tools:[
                [{iconCls:'plus_sign',text:'同步集团最新项目',title:'同步集团最新项目',click:function(){
	                var formData = $('#sbox').sovals();
	                formData.ruleId = id;
                    $ajax.post('${base}/ui/amcs/aps/rule/refreshRuleFromGroup',JSON.stringify(formData),"确定同步最新项目至医院？",true, {calltip:false}).done(function (rst) {
            ...
            columns:[[
                ...
                {title:'计分项目编码',field:'groupItemCode',width:'130px',hidden:false,editor:{type:'readonly'}, sortable:true,},
                {title:'计分项目名称',field:'groupItemName',width:'130px',hidden:false,editor:{type:'readonly'}, sortable:true,},
                {title:'手术等级',field:'itemLevel',width:'65px',editor:{type:'readonly'}, sortable:true,},
                {title:'病种',field:'itemIcd',width:'65px',editor:{type:'readonly'}, sortable:true,},
                {title:'集团计分规则类型',field:'groupRuleItemTypeDesc',width:'102px',hidden:false,editor:{type:'readonly'}, sortable:true,},
                {title:'集团标准分值/比例',field:'groupItemScore',width:'130px',editor:{type:'readonly'}, sortable:true,},
                {title:'医院计分规则类型',field:'ruleItemType',hidden:true,width:0,editor:{type:'readonly'}, sortable:true,},
                ...
                {title:'医院标准分值/比例',field:'itemScore',width:'130px', sortable:true,editor:{type:'diy',options:{validType:'rangeNum[0, 99999, 6,false, false, ""]',required:false,missingMessage:'请填写'}}},
