...
<div class="pad-20 pad-b0">
  <form class="soform form-validate form-enter solab-l mar-b10" method="post" action="${base}/ui/aps/operGrade/update">
  <input type="hidden" name="id" value="${(operGrade.id)!}"/>
    <div class="row">
      <div class="p6"><div class="item-one">
          <label class="lab-item">手术项目：</label>
          <input class="txt easyui-combogrid" type="text" name="operationItem" id="operationItem" value="${(operGrade.operationItem)!}" style="width: 100%;"/>
      </div></div>
      <div class="p6"><div class="item-one">
          <label class="lab-item">手术编码：</label>
          <input class="txt disable" type="text" name="operationCode" id="operationCode" style="width: 100%;" value="${(operGrade.operationCode)!}" readonly="true"/>
      </div></div>
    </div>
    <div class="row">
      <div class="p6"><div class="item-one">
      ...
      <div class="p6"><div class="item-one">
		  ...
		  <input class="txt disable" type="text" name="operationGrade" id="operationGrade" style="width: 100%;" value="${(meritsLevel.operationGrade)!}" readonly="true"/>
      </div></div>
    </div>
    <div class="row">
      <div class="p6"><div class="item-one">
          <label class="lab-item">病种：</label>
           ...
           style="width:100%;" dataOptions="readonly:true,editable:false,limitToList:true" value="${meritsLevel.diseaseType}" readonly="true" uiShowDefault="false"][/@ui_select]
      </div></div>
      <div class="p6"><div class="item-one">
          ...
          [@ui_select id="usingSign" name="usingSign" tag="com.aier.cloud.basic.api.domain.enums.UsingSignEnum"
           style="width:100%;" dataOptions="editable:false,limitToList:true" value="${operGrade.usingSign}" uiShowDefault="false"][/@ui_select]
      </div></div>
    </div>
    <p class="row-btn">
...
require(["editor", "pub"], function (editor) {
        ...
        $('#operationClassify').combogrid('setValue',{ID:'${(meritsLevel.id)!}',OPERATIONCLASSIFY:'${(meritsLevel.operationClassify)!}'});
});
</script>			
</body>
</html>
