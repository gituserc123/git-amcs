...
<span id="${id}" class="search-btn  ${class}"  url="${url}">
    <input class="txt inline wp-75" name="searchKey"  type="text"  placeholder="${placeholder}" maxlength="100" /><button  class="btn btn-small btn-small-b btn-primary btn-searchPatient" type="button">查询</button>
</span>
[/#macro]
