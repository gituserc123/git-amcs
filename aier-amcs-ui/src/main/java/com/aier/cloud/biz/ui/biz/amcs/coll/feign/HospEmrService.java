...
public interface HospEmrService {

	
	@PostMapping(value = "/api/service/biz/amcs/coll/amcsCollHospEmr/findList")
	@ResponseBody
	public PageResponse <Map<String, Object>> findList(@RequestBody CollCondition cond);
	
	
	@PostMapping("/api/service/biz/amcs/coll/amcsCollHospEmr/findById")
    @ResponseBody
    public Map<String, Object> findById(@RequestParam("id") Long id);
	
	@PostMapping("/api/service/biz/amcs/coll/amcsCollHospEmr/save")
    @ResponseBody
