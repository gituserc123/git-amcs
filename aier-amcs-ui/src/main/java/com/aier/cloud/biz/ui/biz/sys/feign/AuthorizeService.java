...
public interface AuthorizeService{
    ...
    public Boolean cancelStaffProvinceRole(@RequestParam("roleId")Long roleId, @RequestParam("staffId") Long staffId);

    @PostMapping(value = "/api/sys/authorize/selectRolesByStaffIdAndInstId")
    public List<Map<String,Object>>  selectRolesByStaffIdAndInstId(@RequestParam("staffId") Long staffId, @RequestParam("instId") Long instId);
