...
//            window.console && console.log(file,response);
            if (response.state == "error") {
                ...
                $hiddenInput.append('<input type="text" id="hiddenInput'+$(item)[0].id + file.id + '" class="hiddenInput" value="' + response.url + '" />')
            }
...
//                    window.console&&console.log(data.message);
    ...
    $.fn.powerWebUpload = function (options) {
        ...
        //     // var casspath = applicationPath + "/js/lib/webuploader/webuploader.css";
        //     // $("<link>").attr({ rel: "stylesheet", type: "text/css", href: casspath }).appendTo("head");
        //     var jspath = applicationPath + "/js/lib/webuploader/webuploader.min.js";
