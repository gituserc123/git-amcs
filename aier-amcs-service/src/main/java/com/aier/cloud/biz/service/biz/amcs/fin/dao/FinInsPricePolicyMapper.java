 ...
 */
public interface FinInsPricePolicyMapper extends BaseMapper<FinInsPricePolicy> {
    List<Map<String, Object>> getAll(Page<Map<String, Object>> page, @Param("cond") FinInsPricePolicyCondition cond);
}