...
@Controller
@RequestMapping("/api/amcs/adverse/aeOtherOptometry")
public class AeOtherOptometryController extends BaseController {

	@Autowired
	private AeOtherOptometryService service;

	@RequestMapping(value = "/selectById")
	public @ResponseBody AeOtherOptometry selectById(@RequestParam("id") Long id) {
