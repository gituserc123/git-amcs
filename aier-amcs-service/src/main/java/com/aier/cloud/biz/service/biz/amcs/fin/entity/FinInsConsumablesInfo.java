 ...
 */
@TableName("T_FIN_INS_CONSUMABLES_INFO")
public class FinInsConsumablesInfo extends BaseEntity<FinInsConsumablesInfo> {
	/** 月主表ID*/
	...
	/** 最大值*/
	@TableField(value="consumables_max")
	private java.math.BigDecimal consumablesMax;
	
	/** 最小值*/
	@TableField(value="consumables_min")
	private java.math.BigDecimal consumablesMin;
	
	/** 耗材名称*/
	@TableField(value="consumables")
	@Length(max=10) private String consumables;
	
	/** 耗材所属类型(1-单病种付费,2-DIP,3-DRG)*/
	@TableField(value="consumables_type")
