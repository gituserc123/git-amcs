...
public interface TransPaymentService {
	 ...
	 * @author lc
	 */
	@RequestMapping(value = "/api/trans/transPayment/getTotalRevenueToday", method = RequestMethod.POST)
	public BigDecimal getTotalRevenueToday(@RequestParam(value = "hospId") Long hospId,
