 ...
 */
public interface AmcsCollHospEmrMapper extends BaseMapper<AmcsCollHospEmr> {
	 
	List<Map<String, Object>> findList(Page<Map<String, Object>> page, @Param("cond") CollCondition cond);
}