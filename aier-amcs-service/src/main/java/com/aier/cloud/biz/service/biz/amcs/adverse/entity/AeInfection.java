...
/**
 * T_AE_INFECTION 医院感染事件上报表单
 * 
 * @author 爱尔眼科
 * @since 2022-10-11 10:27:56
 */
@TableName("T_AE_INFECTION")
public class AeInfection extends BaseEntity<AeInfection> {

	private static final long serialVersionUID = -6352771326132064653L;
	...
	/** 拟施治疗(手术、注药、打激光等) */
    @Comment(value="拟施治疗(手术、注药、打激光等)")
	@TableField(value = "intended_treatment")
	@Length(max = 500)
	private String intendedTreatment;

	/** 实施治疗（手术、注药、打激光等） */
    @Comment(value="实施治疗（手术、注药、打激光等）")
	@TableField(value = "implement_treatment")
	@Length(max = 500)
	private String implementTreatment;
	...
	@AeDictName(type = "cut_type", from = "cutType")
