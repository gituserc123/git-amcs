 ...
 */
@TableName("T_FIN_MA_DIP_DTL")
public class FinMaDipDtl extends BaseEntity<FinMaDipDtl> {
	/** 创建时间*/
	...
	@Length(max=40) private String operationCode;
	
	/** 手术名称*/
	@TableField(value="operation_name")
	@Length(max=40) private String operationName;
	
	/** 诊断名称code*/
	@TableField(value="diag_code")
	@Length(max=40) private String diagCode;
	
	/** 诊断名称*/
	@TableField(value="diag_name")
	@Length(max=40) private String diagName;
