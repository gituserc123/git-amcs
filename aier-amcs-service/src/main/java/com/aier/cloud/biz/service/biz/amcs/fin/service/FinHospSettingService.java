 ...
 */
public interface FinHospSettingService extends IService<FinHospSetting>{
    List<Map<String,Object>> getList(FinHospSettingCondition cond);


    Boolean save(FinHospSetting finHospSetting);
}