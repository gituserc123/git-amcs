 ...
 */
@TableName("T_FIN_INS_DIP_PAY")
public class FinInsDipPay extends BaseEntity<FinInsDipPay> {
	/** 创建者ID*/
	...
	/** DIP总分值控制*/
	@TableField(value="total_score_control")
	...
	public BigDecimal getTotalScoreControl() {
		return totalScoreControl;
	}

	public void setTotalScoreControl(BigDecimal totalScoreControl) {
		this.totalScoreControl = totalScoreControl;
	}
}