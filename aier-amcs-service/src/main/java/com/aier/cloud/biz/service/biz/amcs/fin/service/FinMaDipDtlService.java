 ...
 */
public interface FinMaDipDtlService extends IService<FinMaDipDtl>{

    List<FinMaDipDtl> getAllRecord(FinMaDipDtlCondition cond);
    Map<String, String> save(FinMaDipDtl finMaDipDtl);
}