 ...
 */
public interface AeDrugReactDrugsService extends IService<AeDrugReactDrugs>{

    List<Map<String,Object>> getAllEntity(DrugReactDrugsCondition cond);
    boolean save(AeDrugReactDrugs aeDrugReactDrugs);
